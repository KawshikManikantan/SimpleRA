...
Page::Page(string tableName, int pageIndex,int colCount,int rowCount)
{
    logger.log("Page:: Partition Page");
    this->tableName = tableName;
    this->pageIndex = pageIndex;
    this->pageName = "../data/temp/" + this->tableName + "_Page" + to_string(pageIndex);
...
void Page::modIndexOfRow(int rowIndex,int colIndex,int updateValue)
{
    this->rows[rowIndex][colIndex] = updateValue;
    //cout<<updateValue<<" "<<this->rows[rowIndex][colIndex]<<endl;
}
