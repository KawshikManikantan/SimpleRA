 ...
 * is indicated by E. within this system we simulate blocks by
...
class BufferManager{
    ...
    Page getPartition(string tableName, int pageIndex,int colCount, int rowCount);
    Page insertPartitionIntoPool(string tableName, int pageIndex,int colCount,int rowCount);
    void clearPool();
};